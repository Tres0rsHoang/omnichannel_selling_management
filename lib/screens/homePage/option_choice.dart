            ...
            Wrap(
              ...
              children: List<Widget>.generate(
                ...
                (int index) {
                  ...
                  if(index == 0){
                    return ChoiceChip(
                    avatar: const Icon(Icons.calendar_month,color: Colors.blue,),
                    shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(5)),
                    label: Text(choice[index], style:TextStyle(color: colorTextSelected, fontSize: 12) ,),
                  ...
                  return ChoiceChip(
                    ...
                    shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(5)),
                    label: Text(choice[index], style:TextStyle(color: colorTextSelected) ,),
