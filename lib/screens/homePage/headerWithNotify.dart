                  ...
                  children:<Widget> [
                            ...
                            Column(
                              ...
                              crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  ...
                                  Text("Xin chao, ", style:TextStyle(color: Colors.white60)),
                    ...
                    children:[
                      badges.Badge(
                        ...
                        badgeContent: Text('0'),
                        child: IconButton(
                          icon: Icon(Icons.notifications, color: Theme.of(context).backgroundColor,),
                          onPressed: () {},
                        ),
                      ...
                      badges.Badge(
                        ...
                        badgeContent: Text('0'),
                        child: IconButton(
                          icon: Icon(Icons.message, color: Theme.of(context).backgroundColor,),
                          onPressed: () {},
                        ),
